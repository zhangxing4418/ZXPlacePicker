...
static NSString *const googlePlaceAPIKey = @"AIzaSyCApeNGSvdK-xGn6PCraV5fhbJFurSaBPA";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	if (!googlePlaceAPIKey.length) {
		NSString *bundleId = [[NSBundle mainBundle] bundleIdentifier];
		NSString *format = @"Configure APIKeys inside BusConfig.h for your  bundle `%@`, see "
